---
title: Technical Evidence Index
layout: default
---
...
- Professional outcomes are labelled as direct workflow outcomes or collaborative global portfolio outcomes.
- Fictional scenario inputs remain marked illustrative in every output.
- Deterministic code owns scoring, sizing, calculations, state, and delivery decisions.
- Model-generated interpretation never silently changes a calculation or approval gate.
- Unknown evidence remains visible instead of being replaced by a precise-looking estimate.
- Architecture, benchmark, security, pricing, and finance approval remain explicit human review gates.

[Return to the portfolio](https://github.com/daetan999/technical_resume)
